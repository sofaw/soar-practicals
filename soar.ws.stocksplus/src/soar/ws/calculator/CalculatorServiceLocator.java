...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements soar.ws.calculator.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/soar.ws.calculator/services/Calculator";
    ...
    public soar.ws.calculator.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            soar.ws.calculator.CalculatorSoapBindingStub _stub = new soar.ws.calculator.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (soar.ws.calculator.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                soar.ws.calculator.CalculatorSoapBindingStub _stub = new soar.ws.calculator.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://calculator.ws.soar", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://calculator.ws.soar", "Calculator"));
        }
